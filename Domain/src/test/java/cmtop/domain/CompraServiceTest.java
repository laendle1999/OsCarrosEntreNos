...
public class CompraServiceTest {
	...
	public void CriarCompraServiceTest() throws IOException {
		...
		// this.carro = new Carro(12773, "1", "11", "11", "teste", "teste", "amarelo",
		// 2000, 10000, 10000, "01/01/2000", statusCarro.DISPONIVEL);

		System.out.println("oi2");
		// cs.cadastrarNovaCompraDeCarro("Paulínia", "Benjamin Carros", "05/05/2000",
		// 10000, carro);
