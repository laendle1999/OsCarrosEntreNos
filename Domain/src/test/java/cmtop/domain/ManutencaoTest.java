...
public class ManutencaoTest {
	...
	public void testeCarro() {
		...
		carro = new Carro("Numero","EWI0392","6596416","Honda","Honda","Amarelo",2012,10000,1000,100,statusCarro);
		carro2 = new Carro("Numero","EWI0392","6596416","Honda","Honda","Amarelo",2012,10000,1000,100,statusCarro);
